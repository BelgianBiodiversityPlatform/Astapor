    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vial', models.CharField(blank=True, max_length=100, null=True)),
                ('mnhn_number', models.CharField(blank=True, max_length=100, null=True)),
                ('mna_code', models.CharField(blank=True, max_length=100, null=True)),
                ('bold_process_id', models.CharField(blank=True, max_length=100, null=True)),
                ('bold_sample_id', models.CharField(blank=True, max_length=100, null=True)),
                ('bold_bin', models.CharField(blank=True, max_length=100, null=True)),
                ('sequence_name', models.CharField(blank=True, max_length=100, null=True)),
